...
month = int(input("Δώσε το μήνα που θες:"))
...
if (month == 2):
  if (year%4 == 0) or (year%100 == 0) or (year%400 == 0):
    while (day < 1) or (day > 29) or (day == " "):
      day = int(input("Δώσε την ημέρα που θες:"))
    print("Ο μήνας που δώθηκε έχει 29 μέρες.")
  else:
    while (day < 1) or (day > 28) or (day == " "):
      day = int(input("Δώσε την ημέρα που θες:"))
    print("Ο μήνας που δώθηκε έχει 28 μέρες")
else:
   for i in range(1, 9, 2):
    if (month == i):
        while (day < 1) or (day > 31) or (day == " "):
          day = int(input("Δώσε την ημέρα που θες:"))
        print("Ο μήνας που δώθηκε έχει 31 μέρες.") 
   ...
   for i in range(4, 8, 2):
     if (month == i):
       while (day < 1) or (day > 30) or (day == " "):
        day = int(input("Δώσε την ημέρα που θες:"))
       print("Ο μήνας που δώθηκε έχει 30 μέρες.")
